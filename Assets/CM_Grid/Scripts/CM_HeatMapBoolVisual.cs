...
public class CM_HeatMapBoolVisual : MonoBehaviour
{
    CM_Grid<bool> grid;
    Mesh mesh;
    bool updateMesh;
    ...
    public void SetGrid(CM_Grid<bool> grid)
    {
        this.grid = grid;
        UpdateHeatMapVisual();
    ...
    private void Grid_OnGridValueChanged(object sender, CM_Grid<bool>.OnGridValueChangedEventArgs e)
    {
        //UpdateHeatMapVisual();
        updateMesh = true;
    }
