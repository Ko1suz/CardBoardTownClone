...
public class CM_GridXZ<TGridObject> {
    ...
    public CM_GridXZ(int width, int height, float cellSize, Vector3 originPosition, Func<CM_GridXZ<TGridObject>, int, int, TGridObject> createGridObject) {
        this.width = width;
        this.height = height;
